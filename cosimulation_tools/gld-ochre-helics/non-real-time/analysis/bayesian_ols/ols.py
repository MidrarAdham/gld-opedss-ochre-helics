...
class OLSModel:
    ...
    def fit (
        ...
        The target signal is the background signal, that is the feeder signal assuming all
        devices are OFF. The OLS model predicts how the flex loads behave during the time
        where all of them are off.
