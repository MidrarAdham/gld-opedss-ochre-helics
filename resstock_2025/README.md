...
### tl;dr:
- Copy the envelope.py and hpxml.py files to OCHRE installtion directory:
    - /home/deras/.local/lib/python3.12/site-packages/ochre/utils
        - Or whichever directory OCHRE is installed.
